...
//LPC17xx variables
volatile unsigned long micros_tick = 0;
volatile unsigned long millis_tick = 0;
unsigned long INTERVAL_IN_MICROSECONDS = 1;
...
//LPC17xx interupt for millis
extern "C" void TIMER0_IRQHandler (void){
	micros_tick += INTERVAL_IN_MICROSECONDS;
	unsigned long k_millis;
	k_millis += INTERVAL_IN_MICROSECONDS;
	if (k_millis >= 1000){
		micros + 1;
		k_millis -= 1000;
	}
